...
public class AccessInheritance
{
    ...
    {
        Public access=new Public();
        System.out.print("Public : "+access.publicVar+"\n");
        //System.out.print("Public : "+pub.privateVar);
        //We cannot access the privateVar because it is private and accessible only within the class.
        System.out.print("Private : "+access.getPrivate()+"\n");
        System.out.print("Protected : "+access.protectedVar+"\n");
    }
}
